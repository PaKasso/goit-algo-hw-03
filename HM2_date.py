...
import random
def get_numbers_ticket(min, max, quantity):        # Перевірка валідності вхідних даних
    if min < 1 or max > 1000 or quantity < 1 or quantity > (max - min + 1):
        return []  # Повертаємо пустий список, якщо параметри не відповідають обмеженням

    numbers = set()  # Створюємо множину для унікальних чисел
    while len(numbers) < quantity:        
        numbers.add(random.randint(min, max))    # Генеруємо випадкове число у заданому діапазоні та додаємо його до множини
