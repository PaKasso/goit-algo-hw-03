...
# Список сирих телефонних номерів
raw_numbers = [
     "067\\t123 4567",
     "(095) 234-5678\\n",
     "+380 44 123 4567",
...
def normalize_phone(raw_number):
    ...
    # Додаємо префікс "+380", якщо довжина номеру телефону 10 цифр
    if len(phone_number) == 10:
        phone_number = "+380" + phone_number
    
    # Додаємо префікс "+38", якщо довжина номеру телефону 12 цифр
    if len(phone_number) == 12:
        phone_number = "+38" + phone_number
    
    return phone_number

# Застосовуємо нормалізацію до кожного номеру в списку
